...
int main(int argc, char** argv)
{
	...
	std::cout << std::endl <<"Testing for question 1a." << std::endl;
	{
		...
		if(myMax != 319)
		{
			...
			std::cerr << "Standard case where passed size was the size."
                << std::endl;
			exit(-1);
		}
		...
		{
			std::cerr << "Failed Question 1. ";
			std::cerr << "Standard case where we are only processing part of"
                << "the array." << std::endl;
			exit(-1);
		}
		...
		{
			std::cerr << "Failed Question 1. ";
			std::cerr << "Standard case where max value has been changed from"
                << "first case." << std::endl;
			exit(-1);
		}
		...
		{
			std::cerr << "Failed Question 1. ";
			std::cerr << "Case where the size of the array is < 0."i
                << std::endl;
			exit(-1);
		}
		delete[] myArray;
		...
		{
			std::cerr << "Failed Question 1. ";
			std::cerr << "Case where the maximum value is less than -10000."
                << std::endl;
			exit(-1);
		}
	}
	...
	std::cout << std::endl << "Testing for question 1b." << std::endl;
	{
		...
		{
			std::cerr << "Failed Question 1. ";
			std::cerr << "Case where the size of the array is < 0." 
                << std::endl;
			exit(-1);
		}
		delete[] myArray;
	...
	std::cout << std::endl << "Testing for question 2." << std::endl;
	{
		...
		std::cout << std::endl << "Even numbers between 10 and -10" 
            << std::endl;
	...
	std::cout << std::endl << "Testing for question 3." << std::endl;
	{
		...
		if(res1 != 15)
		{
			std::cerr << "Failed question 3, when B is a multiple of A" 
                << std::endl;
			exit(-3);
		}
		...
		if(res2 != 15)
		{
			std::cerr << "Failed question 3, when A is a multiple of B" 
                << std::endl;
			exit(-3);
		}
		...
		if(res3 != 12)
		{
			std::cerr << "Failed question 3, when multiple is distinct" 
                << std::endl;
			exit(-3);
		}
		...
		if(res7 != -1)
		{
			std::cerr << "Failed question 3, when A and B not viable" 
                << std::endl;
			exit(-3);
		}
	}
	...
	std::cout << std::endl << "Output for the investigation of sizeof." 
        << std::endl;
	{
		lab1.sizeofUse();
	}
